...
public class CountryListActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_list1);
        ...
        btnLoadDB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CountryAdapter countryAdapter = new CountryAdapter(CountryListActivity1.this,
