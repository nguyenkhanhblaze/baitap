...
public class CountryListActivity2 extends AppCompatActivity implements View.OnClickListener {
...
//                countries = new ArrayList<>();
    ...
    void setAdapter(List<Country> countries){
        ...
        CountryAdapter countryAdapter = new CountryAdapter(CountryListActivity2.this,
    ...
    void update(){
        ...
        if(count> 0)
            Toast.makeText(CountryListActivity2.this, "update success", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(CountryListActivity2.this, "update fail", Toast.LENGTH_SHORT).show();
        //buoc 3: close DB
        database.close();
    }
    ...
    void delete(){
       ...
       /* int count = database.delete(Country.TABLE_NAME,
        ...
        int count = database.delete(Country.TABLE_NAME,
                ...
                null );
        if(count> 0)
            Toast.makeText(CountryListActivity2.this, "del success", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(CountryListActivity2.this, "del fail", Toast.LENGTH_SHORT).show();
