package com.example.latitude.database;
...
public class CountryListActivity3 extends AppCompatActivity implements View.OnClickListener{
...
//                countries = new ArrayList<>();
    ...
    void setAdapter(List<Country> countries){
        ...
        CountryAdapter countryAdapter = new CountryAdapter(CountryListActivity3.this,
...
//        SQLiteDatabase database = openDB();
        ...
        if(count> 0)
            Toast.makeText(CountryListActivity3.this, "update success", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(CountryListActivity3.this, "update fail", Toast.LENGTH_SHORT).show();
...
//        SQLiteDatabase database = openDB();
       ...
       /* int count = database.delete(Country.TABLE_NAME,
        ...
        int count = database.delete(Country.TABLE_NAME,
                ...
                null );
        if(count> 0)
            Toast.makeText(CountryListActivity3.this, "del success", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(CountryListActivity3.this, "del fail", Toast.LENGTH_SHORT).show();
